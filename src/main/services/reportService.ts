...
<head>
  ...
  <title>cleanonx System Report - ${dateStr}</title>
  <style>
...
<body>
  <div class="container">
    ...
    <div class="footer">
      Generated by cleanonx System Optimizer
    </div>
  </div>
</body>
</html>`

    const fileName = `cleanonx-report-${now.getFullYear()}-${String(now.getMonth() + 1).padStart(2, '0')}-${String(now.getDate()).padStart(2, '0')}.html`
